...
public interface RocketChatService {
    ...
    @GET("/api/v1/im.files")
    Call<RocketChatFileMessageWrapperDto> getAllFileFromDirectMessages(@HeaderMap Map<String, String> header, @Query("roomId") String dmId, @Query("limit") long limit, @Query("offset") long offset);
}
